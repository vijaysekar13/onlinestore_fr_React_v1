...
export const Iphonephone = () => {
  const [setdata, setSelectedData] = useState();
const handleSubmit = () => {
    fetch(`http://localhost:8080/product/getbrand?brandname=IPhone&categoryname=Mobile`)    
         .then((response)=>{
            if(!response.ok) {
