                ...
                <div class="row">
                    <div class="col-xl-4 col-md-4 mb-30">
                        <div class="single-cta">
                            ...
                            <div class="cta-text">
                                <h4>Find us</h4>
                                <span>393 complex, sw 910, sivagangai</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-md-4 mb-30">
                    ...
                    <div class="col-xl-4 col-lg-4 mb-50">
                        <div class="footer-widget">
                            <div class="footer-logo">
                                <a href="index.html"><img src="https://www.nicepng.com/png/detail/61-612905_customer-centric-creative-design-that-works-on-all.png" class="img-fluid" alt="logo"/></a>
                            </div>
                            ...
                            <div class="footer-social-icon p-5">
                                <h2>Follow us</h2>
                                <br></br>
                                <a href="#">
  ...
  <path d="M12.6.75h2.454l-5.36 6.142L16 15.25h-4.937l-3.867-5.07-4.425 5.07H.316l5.733-6.57L0 .75h5.063l3.495 4.633L12.601.75Zm-.86 13.028h1.36L4.323 2.145H2.865z"/>
        ...
        <div >
                        <div class="copyright-text text-center">
                            <p>Copyright &copy; 2024, All Right Reserved <a href="https://codepen.io/anupkumar92/">Smart Mobile</a></p>
                        </div>        
            </div>
